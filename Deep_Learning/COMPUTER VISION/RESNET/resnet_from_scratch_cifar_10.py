# -*- coding: utf-8 -*-
"""RESNET_FROM_SCRATCH_CIFAR_10_Expo.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/194xMs56M77UcELLN-SdteOdOaVK1Htps
"""
...
valid_ds = torchvision.datasets.CIFAR10(root='./data', train=False, transform=transform, download=True)
...
def fit_one_cycle(epochs, max_lr, model, train_loader, val_loader,
                  weight_decay=0, grad_clip=None, opt_func=torch.optim.SGD, gamma=0.9):
    torch.cuda.empty_cache()
    history = []
